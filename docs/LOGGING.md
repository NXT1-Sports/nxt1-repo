...
```
[2024-12-24 10:30:45.123] INFO [ProfileComponent] Profile loaded
  userId: "user-123"
```
...
describe('ProfileComponent', () => {
  ...
  beforeEach(() => {
    logger = jasmine.createSpyObj('LoggingService', ['info', 'error', 'child']);
    logger.child.and.returnValue(logger);
