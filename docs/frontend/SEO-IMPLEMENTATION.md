...
- [SSR-FIREBASE-APP-HOSTING.md](../infrastructure/SSR-FIREBASE-APP-HOSTING.md) -
  Full SSR architecture guide
- [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) - Overall monorepo
  structure
