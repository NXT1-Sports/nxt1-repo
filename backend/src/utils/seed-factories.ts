...
export function buildScheduleEvents(uid: string): ScheduleEvent[] {
  return [
    ...
    },
    {
      ...
      eventType: 'camp',
      title: 'Vietnam Football Academy Summer Camp',
      date: daysFromNow(35),
      endDate: daysFromNow(38),
      location: 'VinUniversity Sports Center, Hanoi',
      url: 'https://vfa.edu.vn',
      sport: 'football',
      source: 'manual',
    },
    {
      ...
      eventType: 'camp',
      title: 'Southeast Asia QB Skills Camp',
      date: daysFromNow(50),
      endDate: daysFromNow(51),
      location: 'Bangkok International Sports Complex, Thailand',
      sport: 'football',
      source: 'manual',
    },
    {
    ...
    },
    {
      ...
      eventType: 'visit',
      title: 'Unofficial Visit — RMIT Vietnam',
      date: daysFromNow(18),
      location: 'RMIT Campus, HCMC',
      sport: 'football',
      source: 'manual',
    },
    {
      ...
      eventType: 'visit',
      title: 'Official Visit — FPT University',
      date: daysFromNow(40),
    ...
    },
    {
      ...
      eventType: 'visit',
      title: 'Campus Tour — Hanoi University of Science & Technology',
      date: daysAgo(20),
      location: 'HUST Campus, Hanoi',
    ...
    },
    {
      ...
      date: daysFromNow(25),
      location: 'Hanoi National Stadium',
      sport: 'football',
      source: 'manual',
    },
    {
      ...
      eventType: 'combine',
      title: 'Vietnam Elite Athlete Combine',
      date: daysAgo(40),
      location: 'HCMC Sports Complex, Field A',
      sport: 'football',
      source: 'manual',
    },
    {
      ...
      eventType: 'other',
      title: 'Vietnam Elite Prospect Showcase',
      date: daysFromNow(42),
      endDate: daysFromNow(43),
      location: 'HCMC Sports Complex, Main Arena',
      url: 'https://nxt1sports.com',
      sport: 'football',
      source: 'manual',
    },
...
export function buildBasketballScheduleEvents(uid: string): ScheduleEvent[] {
  return [
    ...
    },
    {
      ...
      eventType: 'other',
      title: 'Southern Vietnam Basketball Showcase',
      date: daysAgo(50),
      location: 'HCMC Indoor Stadium',
      sport: 'basketball',
      source: 'manual',
    },
  ];
...
const SEED_ATHLETE_NAMES: readonly { first: string; last: string }[] = [
  { first: 'Minh', last: 'Tran' },
  { first: 'Quan', last: 'Le' },
  { first: 'Bao', last: 'Nguyen' },
  { first: 'Nam', last: 'Pham' },
  { first: 'Duc', last: 'Vo' },
  { first: 'Khoa', last: 'Dinh' },
  { first: 'Hieu', last: 'Hoang' },
  { first: 'Long', last: 'Dang' },
];
...
export function buildUserProfileFields(uid: string): UserProfileFields {
  ...
  return {
    teamHistory: [
      {
        name: 'Hanoi National High School',
        type: 'high-school',
        logoUrl: null,
        sport: 'football',
        location: { city: 'Hanoi', state: 'HN' },
      ...
      {
        name: 'HCMC Panthers AAU',
        type: 'aau',
        logoUrl: null,
        sport: 'football',
        location: { city: 'Ho Chi Minh City', state: 'HCM' },
        record: { wins: 14, losses: 4 },
        startDate: '2024-06-01',
        isCurrent: true,
      },
      {
        name: 'Vinschool Hanoi',
        type: 'club',
        logoUrl: null,
        sport: 'basketball',
        location: { city: 'Hanoi', state: 'HN' },
    ...
    awards: [
      {
        ...
        sport: 'football',
        season: '2024-2025',
        issuer: 'Hanoi District Athletic Association',
        date: '2025-01-15',
      },
      {
      ...
      },
      {
        ...
        category: 'academic',
        season: '2024-2025',
        issuer: 'Vietnam High School Athletic League',
        date: '2025-05-20',
      },
    ],
    contact: {
    ...
    coachContact: {
      firstName: 'Duc',
      lastName: 'Nguyen',
      email: 'coach.duc@vinuniversity.edu.vn',
    ...
    basicProfile: {
      ...
      classOf: 2026,
      location: { city: 'Hanoi', state: 'HN', country: 'VN' },
      height: '6\'1"',
      weight: 185,
