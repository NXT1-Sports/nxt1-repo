/**
 * @fileoverview Agent X Dashboard Routes
 * @module @nxt1/backend/routes/agent-x/dashboard
 *
 * Routes: /history, /operations-log, /dashboard, /goals
 */
...
import { isLegacyFallbackPlaybook } from '../../modules/agent/services/generation.service.js';
import {
  queueService,
  jobRepository,
  chatService,
