/**
 * @fileoverview Agent X Cron Routes
 * @module @nxt1/backend/routes/agent-x/cron
 *
 * Routes: /cron/daily-briefings, /cron/summarize-threads, /cron/cleanup-thread-media
 * Triggered by Cloud Scheduler only (cronGuard enforced).
 */
