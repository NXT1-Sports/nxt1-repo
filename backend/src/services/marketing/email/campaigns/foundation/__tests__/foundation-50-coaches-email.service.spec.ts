...
describe('buildFoundation50CoachesPreview', () => {
  it('includes UTM attribution on all Foundation 50 CTA links', () => {
    ...
    expect(preview.html).toContain(
      'https://calendar.app.google/26DJG2MZjQog3wvt5?utm_source=email&utm_medium=outbound&utm_campaign=foundation_50_coaches&utm_content=schedule_founder_meeting&utm_term=initial'
    );
    expect(preview.html).toContain(
