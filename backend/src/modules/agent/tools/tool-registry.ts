...
const TOOL_ENTITY_GROUP_OVERRIDES: Readonly<Record<string, AgentToolEntityGroup>> = {
  ...
  create_universal_team_document: 'team_tools',
  list_universal_team_documents: 'team_tools',
  get_universal_team_document: 'team_tools',
  update_universal_team_document: 'team_tools',
  delete_universal_team_document: 'team_tools',
  list_team_file_folders: 'team_tools',
  create_team_file_folder: 'team_tools',
  update_team_file_folder: 'team_tools',
  delete_team_file_folder: 'team_tools',
  move_universal_file_to_folder: 'team_tools',
