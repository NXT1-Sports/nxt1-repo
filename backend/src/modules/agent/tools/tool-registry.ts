...
const TOOL_ENTITY_GROUP_OVERRIDES: Readonly<Record<string, AgentToolEntityGroup>> = {
  ...
  list_film_review_playlists: 'team_tools',
  ...
  move_film_review_to_playlist: 'team_tools',
  create_film_review_playlist: 'team_tools',
  update_film_review_playlist: 'team_tools',
  delete_film_review_playlist: 'team_tools',
