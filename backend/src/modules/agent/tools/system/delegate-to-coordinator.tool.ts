...
export class DelegateToCoordinatorTool extends BaseTool {
  ...
  readonly description =
    ...
    '• data_coordinator — Structured data ingestion and canonical record updates ONLY: create posts (team posts, timeline announcements, season recaps), write season stats, rankings, metrics, roster entries, schedule, recruiting activity, calendar events, connected sources, ingest data from external URLs (MaxPreps, Hudl, 247Sports, etc.), visualize imported/extracted datasets as charts or spreadsheet-style tables, and perform direct profile field updates such as firstName, lastName, displayName, email, phone, aboutMe, city, state, country, or sport-scoped positions. Do NOT use data_coordinator for strategy artifacts such as callsheets, practice script matrices, playbooks, game plans, or play diagrams.\n' +
    ...
    '• admin_coordinator — Compliance, platform administration, support tickets, user management, and recurring task scheduling. Do NOT use admin_coordinator for routine user profile field edits when the goal is to change saved profile data; those belong to data_coordinator.\n' +
