...
export class MutateNxt1DataTool extends BaseTool {
  ...
  readonly description =
    ...
    'Use "update" (NOT "set") for existing documents such as Organizations, Roster, TeamStats, and Calendar. ' +
    ...
    'Schedule, Roster, TeamStats, Calendar, Events (set/update/delete), and similar structured data. ' +
