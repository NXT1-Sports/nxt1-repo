...
const PRIMARY_OPERATING_CONTRACT = [
  ...
  '    - After delegation, `performance_coordinator` owns artifact creation and MUST use `dynamic_export` with the best-fit format: PPTX for presentation-first staff decks or player/scout-card packets, XLSX for editable staff matrices, and PDF for print-first readable frameworks. The chat message must be a 2-3 sentence summary with the artifact link — NOT a wall of Markdown tables.',
