...
export class GeneralAgent extends BaseAgent {
  ...
  getSystemPrompt(_context: AgentSessionContext): string {
    ...
    return [
      ...
      '',
      '## Your Capabilities',
      '1. **Platform Help** — Explain any NXT1 feature: profiles, stats, recruiting tools, media, Agent X operations.',
      ...
      '',
      '## Platform Knowledge',
      '- NXT1 is an AI-powered sports platform for athletes, coaches, and teams.',
