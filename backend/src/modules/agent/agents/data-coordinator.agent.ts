...
export class DataCoordinatorAgent extends BaseAgent {
  ...
  getSystemPrompt(_context: AgentSessionContext): string {
    ...
    const prompt = [
      ...
      '  2a. If you generated a chart and the user also needs a PDF export, pass the chart `imageUrl`/`chartUrl` into `dynamic_export.imageUrls` so the PDF embeds the chart image (same export behavior as play/board diagrams).',
