...
STRIPE_PRICE_ID_PRODUCTION_AI_GRAPHIC=price_...
STRIPE_PRICE_ID_PRODUCTION_HIGHLIGHT=price_...

# Stripe Staging
STRIPE_TEST_SECRET_KEY=sk_test_...
STRIPE_TEST_WEBHOOK_SECRET=whsec_...
STRIPE_PRICE_ID_STAGING_AI_GRAPHIC=price_...
```
...
# Test webhook
stripe listen --forward-to http://localhost:3000/api/v1/webhook
