...
const PROGRESS_PATH = resolve(LOGS_DIR, 'monthly-campaign-02-dispatch-progress.json');
const FAILURES_PATH = resolve(LOGS_DIR, 'monthly-campaign-02-dispatch-failures.json');
...
async function main(): Promise<void> {
  ...
  console.log('Monthly campaign 02 dispatcher sender');
