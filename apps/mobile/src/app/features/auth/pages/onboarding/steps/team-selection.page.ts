/**
 * @fileoverview Team Selection Step Page
...
@Component({
  selector: 'app-onboarding-team-selection-step',
  standalone: true,
  imports: [
    IonContent,
    AuthShellComponent,
        ...
        <div authContent class="nxt1-onboarding-step">
          ...
          @if (contentReady()) {
            <nxt1-onboarding-team-selection-step
              [teamSelectionData]="onboarding.teamSelectionFormData()"
              [sportData]="onboarding.sportFormData()"
              [disabled]="onboarding.isLoading()"
              [searchTeams]="onboarding.searchTeamsFn"
              [userType]="onboarding.selectedRole()"
              variant="list-row"
              (teamSelectionChange)="onboarding.onTeamSelectionChange($event)"
            />
          }
        </div>
      </nxt1-auth-shell>
...
export class OnboardingTeamSelectionStepPage {
