/**
 * @fileoverview School/Team Step Page
...
@Component({
  selector: 'app-onboarding-school-step',
  standalone: true,
  imports: [
    IonContent,
    AuthShellComponent,
        ...
        <div authContent class="nxt1-onboarding-step">
          ...
          @if (contentReady()) {
            <nxt1-onboarding-team-step
              [teamData]="onboarding.teamFormData()"
              [disabled]="onboarding.isLoading()"
              (teamChange)="onboarding.onTeamChange($event)"
            />
          }
        </div>
      </nxt1-auth-shell>
...
export class OnboardingSchoolStepPage {
