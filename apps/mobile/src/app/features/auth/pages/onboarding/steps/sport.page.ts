/**
 * @fileoverview Sport Selection Step Page
...
@Component({
  selector: 'app-onboarding-sport-step',
  standalone: true,
  imports: [
    IonContent,
    AuthShellComponent,
        ...
        <div authContent class="nxt1-onboarding-step">
          ...
          @if (contentReady()) {
            <nxt1-onboarding-sport-step
              ...
              variant="list-row"
              (sportChange)="onboarding.onSportChange($event)"
            />
          }
        </div>
      </nxt1-auth-shell>
...
export class OnboardingSportStepPage {
