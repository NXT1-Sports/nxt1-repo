...
import { NxtRecruitingAthletesLandingComponent } from '../shared/personas';
...
export class RecruitingAthletesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.updatePage({
      ...
      description:
        'Open doors to every college program in the country. NXT1 gives athletes direct access to 85,000+ college coaches with one click — plus AI-powered radar shows you exactly who is watching your profile.',
      keywords: [
        'college connections',
        'ncaa coaches',
        'AI radar',
