...
import { MEDIA_SCHEMA_VERSION } from '../../constants/schema.constants';

import type { MediaStatus, VideoType } from '../../constants/media.constants';

// Re-export for backward compatibility
export { MEDIA_SCHEMA_VERSION, MEDIA_STATUSES, VIDEO_TYPES, STORAGE_LIMITS };

export type { MediaStatus, VideoType };
