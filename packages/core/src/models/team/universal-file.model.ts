...
export function createUniversalFilmReviewPayload(
  ...
  return {
    ...
    trackingStatus: review.trackingStatus,
    trackingCapability: review.trackingCapability,
    trackingManifest: review.trackingManifest,
    trackingProgress: review.trackingProgress,
    trackingModelBundleVersion: review.trackingModelBundleVersion,
    trackingSourceContentHash: review.trackingSourceContentHash,
    trackingCorrectionRevision: review.trackingCorrectionRevision,
    trackingCorrections: review.trackingCorrections,
    trackingError: review.trackingError,
