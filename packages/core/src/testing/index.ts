...
export const USAGE_TEST_IDS = {
  ...
  BILLING_CONTEXT_BADGE: 'usage-billing-context-badge',
...
export const PLAYBOOK_TEST_IDS = {
  ...
  PLAYBOOK_PRINT_PREVIEW_BUTTON: 'playbook-print-button',
  PLAYBOOK_EXPORT_ERROR: 'playbook-print-error',
  PLAYBOOK_PRINT_MODAL: 'playbook-print-modal',
  PLAYBOOK_PRINT_MODE_CURRENT_BUTTON: 'playbook-print-mode-current-button',
  PLAYBOOK_PRINT_MODE_FULL_BUTTON: 'playbook-print-mode-full-button',
  PLAYBOOK_PRINT_TARGET_PLAYS_BUTTON: 'playbook-print-target-plays-button',
  PLAYBOOK_PRINT_TARGET_INSTALL_BUTTON: 'playbook-print-target-install-button',
  PLAYBOOK_PRINT_TARGET_CALLSHEET_BUTTON: 'playbook-print-target-callsheet-button',
  PLAYBOOK_PRINT_TARGET_PRACTICE_SCRIPT_BUTTON: 'playbook-print-target-practice-script-button',
  PLAYBOOK_PRINT_FILTERED_TOGGLE: 'playbook-print-filtered-toggle',
  PLAYBOOK_PRINT_GENERATED_CALLSHEET_TOGGLE: 'playbook-print-generated-callsheet-toggle',
  PLAYBOOK_PRINT_CALLSHEET_SELECT: 'playbook-print-callsheet-select',
  PLAYBOOK_PRINT_PRACTICE_SCRIPT_SELECT: 'playbook-print-practice-script-select',
  PLAYBOOK_PRINT_SUMMARY: 'playbook-print-summary',
  PLAYBOOK_PRINT_CONFIRM_BUTTON: 'playbook-print-confirm-button',
  PLAYBOOK_PRINT_CANCEL_BUTTON: 'playbook-print-cancel-button',
...
export const FILM_REVIEW_TEST_IDS = {
  ...
  UPLOAD_MENU: 'film-review-upload-menu',
  UPLOAD_BATCH_OPTION: 'film-review-upload-batch-option',
  UPLOAD_FULL_OPTION: 'film-review-upload-full-option',
  ...
  ATTACH_BREAKDOWN_CONTEXT_BUTTON: 'film-review-attach-breakdown-context-button',
  DOWNLOAD_BUTTON: 'film-review-download-button',
  DOWNLOAD_MENU: 'film-review-download-menu',
  DOWNLOAD_VIDEO_OPTION: 'film-review-download-video-option',
  DOWNLOAD_BREAKDOWN_OPTION: 'film-review-download-breakdown-option',
  ...
  TIMELINE_COLUMN_FILTER_MENU: 'film-review-timeline-column-filter-menu',
  TIMELINE_COLUMN_FILTER_OPTIONS: 'film-review-timeline-column-filter-options',
  TIMELINE_COLUMN_FILTER_INCLUDE: 'film-review-timeline-column-filter-include',
  TIMELINE_COLUMN_FILTER_EXCLUDE: 'film-review-timeline-column-filter-exclude',
  TIMELINE_COLUMN_FILTER_CLEAR: 'film-review-timeline-column-filter-clear',
  TIMELINE_FILTER_CHIPS: 'film-review-timeline-filter-chips',
  TIMELINE_FILTER_CHIP: 'film-review-timeline-filter-chip',
  TIMELINE_FILTER_CLEAR_ALL: 'film-review-timeline-filter-clear-all',
  TIMELINE_FILTER_EMPTY_STATE: 'film-review-timeline-filter-empty-state',
  TIMELINE_COLUMN_REORDER_HANDLE: 'film-review-timeline-column-reorder-handle',
  TIMELINE_PLAY_NAV_PREV: 'film-review-timeline-play-nav-prev',
  TIMELINE_PLAY_NAV_NEXT: 'film-review-timeline-play-nav-next',
  TIMELINE_SELECT_ALL_CHECKBOX: 'film-review-timeline-select-all-checkbox',
  TIMELINE_PLAY_SELECT_CHECKBOX: 'film-review-timeline-play-select-checkbox',
  TIMELINE_PLAY_REORDER_HANDLE: 'film-review-timeline-play-reorder-handle',
...
export const DIAGRAMS_LAB_TEST_IDS = {
  ...
  BUILDER_UNDO_BUTTON: 'diagrams-lab-builder-undo-button',
  BUILDER_REDO_BUTTON: 'diagrams-lab-builder-redo-button',
  BUILDER_SAVE_BUTTON: 'diagrams-lab-builder-save-button',
  BUILDER_DISCARD_BUTTON: 'diagrams-lab-builder-discard-button',
  BUILDER_TOOL_PALETTE: 'diagrams-lab-builder-tool-palette',
  BUILDER_ADD_PLAYER_BUTTON: 'diagrams-lab-builder-add-player-button',
  BUILDER_ADD_TEXT_BUTTON: 'diagrams-lab-builder-add-text-button',
  BUILDER_ADD_BLOCK_BUTTON: 'diagrams-lab-builder-add-block-button',
  BUILDER_ADD_MOTION_BUTTON: 'diagrams-lab-builder-add-motion-button',
