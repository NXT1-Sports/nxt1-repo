...
export const APP_EVENTS = {
  ...
  // ============================================
  // AGENT THREAD-AS-TRUTH EVENTS (Phase I)
  // ============================================
  /** Canonical LLMMessage[] replay loaded from MongoDB on a turn boundary. */
  AGENT_THREAD_REPLAY_LOADED: 'agent_thread_replay_loaded',
  /** Single LLMMessage row appended via ThreadMessageWriter (assistant/tool). */
  AGENT_THREAD_MESSAGE_APPENDED: 'agent_thread_message_appended',
  /** Prompt budget governor trimmed an oversized tool result row. */
  AGENT_BUDGET_TOOL_TRIMMED: 'agent_budget_tool_trimmed',

  // ============================================
  // WELCOME GRAPHIC EVENTS
  // ============================================
  /** Welcome graphic generated by Agent X */
  ...
  AGENT_X_MESSAGE_EDIT_SAVED: 'agent_x_message_edit_saved',
  /** User deleted a persisted message */
  AGENT_X_MESSAGE_DELETED: 'agent_x_message_deleted',
  /** User restored a deleted message from undo banner */
  AGENT_X_MESSAGE_UNDONE: 'agent_x_message_undone',
  ...
  /** User paused an in-progress Agent X operation — stream aborted locally and backend persisted a resumable paused state */
  AGENT_X_STREAM_PAUSED: 'agent_x_stream_paused',
  ...
  // ============================================
  /** Agent X firecrawl_agent_research job was started */
