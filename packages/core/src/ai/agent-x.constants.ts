...
export const ATHLETE_COORDINATORS: readonly ShellCommandCategory[] = [
  {
    ...
    scheduledActions: [
      {
        id: 'sched-weekly-outreach',
        label: 'Weekly Coach Outreach',
        subLabel: 'Auto-send emails to target coaches every week',
        icon: 'mail',
      },
      {
        id: 'sched-target-list-review',
        label: 'Target List Review',
        subLabel: 'Refresh your school list every two weeks',
        icon: 'list',
      },
      {
        id: 'sched-eligibility-check',
        label: 'Eligibility Check',
        subLabel: 'Verify NCAA/NAIA status monthly',
        icon: 'shieldCheck',
      },
      {
        id: 'sched-timeline-reminder',
        label: 'Timeline Reminder',
        subLabel: 'Get notified before key recruiting dates',
        icon: 'calendar',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-weekly-content',
        label: 'Weekly Content Drop',
        subLabel: 'Auto-draft posts every Monday',
        icon: 'plus',
      },
      {
        id: 'sched-highlight-update',
        label: 'Monthly Highlight Update',
        subLabel: 'Refresh your reel with new clips',
        icon: 'videocam',
      },
      {
        id: 'sched-social-audit',
        label: 'Monthly Social Audit',
        subLabel: 'Review your brand presence across platforms',
        icon: 'analytics',
      },
      {
        id: 'sched-story-batch',
        label: 'Weekly Story Batch',
        subLabel: 'Queue up stories for the week ahead',
        icon: 'image',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-weekly-stats',
        label: 'Weekly Stat Update',
        subLabel: 'Auto-log game stats every week',
        icon: 'trendingUp',
      },
      {
        id: 'sched-monthly-scout',
        label: 'Monthly Scout Report',
        subLabel: 'Generate a fresh eval each month',
        icon: 'clipboard',
      },
      {
        id: 'sched-film-breakdown',
        label: 'Weekly Film Breakdown',
        subLabel: 'Analyze latest game tape automatically',
        icon: 'play',
      },
      {
        id: 'sched-performance-review',
        label: 'Bi-Weekly Performance Review',
        subLabel: 'Track progress against benchmarks',
        icon: 'barChart',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-gpa-check',
        label: 'Weekly GPA Check',
        subLabel: 'Keep your grades on track for eligibility',
        icon: 'clipboard',
      },
      {
        id: 'sched-test-prep',
        label: 'Test Prep Reminder',
        subLabel: 'Stay consistent with SAT/ACT study',
        icon: 'book',
      },
      {
        id: 'sched-eligibility-verify',
        label: 'Monthly Eligibility Verify',
        subLabel: 'Confirm core course progress each month',
        icon: 'shieldCheck',
      },
      {
        id: 'sched-transcript-review',
        label: 'Semester Transcript Review',
        subLabel: 'Review transcript before sending to colleges',
        icon: 'document',
      },
    ],
  },
...
export const TEAM_COORDINATORS: readonly ShellCommandCategory[] = [
  {
    ...
    scheduledActions: [
      {
        id: 'sched-roster-review',
        label: 'Weekly Roster Review',
        subLabel: 'Check depth chart and availability updates',
        icon: 'people',
      },
      {
        id: 'sched-tryout-reminders',
        label: 'Tryout Reminders',
        subLabel: 'Notify players ahead of tryout windows',
        icon: 'calendar',
      },
      {
        id: 'sched-depth-chart-update',
        label: 'Depth Chart Update',
        subLabel: 'Refresh starters and backups weekly',
        icon: 'list',
      },
      {
        id: 'sched-injury-report',
        label: 'Injury Report Check',
        subLabel: 'Review return-to-play status each week',
        icon: 'clipboard',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-prospect-scan',
        label: 'Weekly Prospect Scan',
        subLabel: 'Auto-discover new recruits in target regions',
        icon: 'search',
      },
      {
        id: 'sched-eval-review',
        label: 'Evaluation Review',
        subLabel: 'Summarize pending evaluations weekly',
        icon: 'clipboard',
      },
      {
        id: 'sched-recruit-pipeline',
        label: 'Pipeline Update',
        subLabel: 'Refresh recruit funnel status bi-weekly',
        icon: 'analytics',
      },
      {
        id: 'sched-board-cleanup',
        label: 'Board Cleanup',
        subLabel: 'Remove committed/inactive prospects monthly',
        icon: 'list',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-team-content-plan',
        label: 'Weekly Content Plan',
        subLabel: 'Auto-draft team posts every Monday',
        icon: 'calendar',
      },
      {
        id: 'sched-graphic-drops',
        label: 'Gameday Graphic Drops',
        subLabel: 'Generate matchup graphics before each game',
        icon: 'image',
      },
      {
        id: 'sched-season-recap',
        label: 'Monthly Season Recap',
        subLabel: 'Compile highlights and stats monthly',
        icon: 'videocam',
      },
      {
        id: 'sched-social-analytics',
        label: 'Weekly Social Analytics',
        subLabel: 'Review engagement and reach across platforms',
        icon: 'analytics',
      },
    ],
  },
  {
    ...
    scheduledActions: [
      {
        id: 'sched-outreach-batch',
        label: 'Weekly Outreach Batch',
        subLabel: 'Auto-send intro emails to new prospects',
        icon: 'mail',
      },
      {
        id: 'sched-pipeline-review',
        label: 'Pipeline Review',
        subLabel: 'Review recruiting funnel bi-weekly',
        icon: 'analytics',
      },
      {
        id: 'sched-compliance-calendar',
        label: 'Compliance Calendar',
        subLabel: 'Stay within contact period rules',
        icon: 'shieldCheck',
      },
      {
        id: 'sched-camp-scout',
        label: 'Camp Scout',
        subLabel: 'Review upcoming camps and showcase events',
        icon: 'search',
      },
    ],
  },
