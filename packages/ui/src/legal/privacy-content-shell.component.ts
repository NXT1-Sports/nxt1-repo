...
import { PRIVACY_CONTENT } from '@nxt1/core';
...
@Component({
  ...
  template: `
    @if (showHeader()) {
      <nxt1-page-header title="Privacy Policy" [showBack]="showBack()" (backClick)="back.emit()" />
    }
...
export class PrivacyContentShellComponent {
  ...
  protected readonly content = PRIVACY_CONTENT;
}
