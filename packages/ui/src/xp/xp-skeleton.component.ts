/**
 * @fileoverview XP Skeleton Component - Loading States
 * @module @nxt1/ui/xp
 * @version 1.0.0
 *
 * Loading skeleton components for XP feature.
      ...
      <div class="skeleton-categories">
        @for (i of categoryCount; track i) {
          <div class="skeleton-category">
            ...
            @if (i === 0) {
              <div class="skeleton-xp-tasks">
                @for (j of missionCount; track j) {
                  <div class="skeleton-xp-task">
  ...
  styles: [
    `
      ...
      /* ============================================
       ...
       Uses global design tokens from @nxt1/design-tokens
       ============================================ */
...
export class XpSkeletonComponent {
  // ============================================
  // INPUTS
  // ============================================
...
@Component({
  selector: 'nxt1-xp-progress-skeleton',
  standalone: true,
  imports: [CommonModule],
  template: `
...
export class XpProgressSkeletonComponent {}

@Component({
  selector: 'nxt1-xp-item-skeleton',
  standalone: true,
  imports: [CommonModule],
  template: `
...
export class XpItemSkeletonComponent {}
