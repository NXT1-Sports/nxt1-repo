/**
 * @fileoverview XP Shell Component - Main Container
 * @module @nxt1/ui/xp
 * @version 1.0.0
 *
 * Main container component for the XP tasks feature.
...
export class XpShellComponent {
  ...
  protected readonly featuredMission = computed(() => {
    const missions = this.xpService.missions();
  ...
  protected handleRefresh(event: CustomEvent): void {
    this.xpService.loadMissions(this.userRole()).then(() => {
