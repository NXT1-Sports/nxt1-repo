/**
 * @fileoverview Mock XP Data for Development
 * @module @nxt1/ui/xp/mock-data
 *
 * ⚠️ TEMPORARY FILE - Delete when backend is ready
 *
 * Contains realistic mock data for XP feature during development phase.
 * All data here is fabricated for UI testing purposes only.
 *
 * Includes:
 * - Athlete XP tasks across all categories
 * - Coach XP tasks across all categories
 * - User progress data
 * - Badge data
 */
...
/**
 * Profile Building XP tasks for athletes.
 */
const ATHLETE_PROFILE_XP_TASKS: Mission[] = [
  {
    id: 'ath-profile-1',
...
/**
 * Visibility & Engagement XP tasks for athletes.
 */
const ATHLETE_ENGAGEMENT_XP_TASKS: Mission[] = [
  {
    id: 'ath-engage-1',
  ...
  },
  {
    ...
    category: 'visibility-engagement',
    targetRole: 'athlete',
    title: 'Explore 5 college programs',
    description:
      "Browse colleges you're interested in to learn about their programs and recruiting.",
    status: 'in-progress',
    priority: 'high',
    recurrence: 'once',
    icon: 'school-outline',
    ...
    estimatedMinutes: 5,
    socialProof: 'Athletes who research programs are 3x more likely to be noticed',
    order: 2,
    progress: 60,
    featured: true,
  },
...
/**
 * Recruiting Goals XP tasks for athletes.
 */
const ATHLETE_RECRUITING_XP_TASKS: Mission[] = [
  {
    id: 'ath-recruit-1',
...
/**
 * Seasonal Tasks XP tasks for athletes.
 */
const ATHLETE_SEASONAL_XP_TASKS: Mission[] = [
  {
    id: 'ath-season-1',
...
/**
 * Team Setup XP tasks for coaches.
 */
const COACH_TEAM_SETUP_XP_TASKS: Mission[] = [
  {
    id: 'coach-team-1',
    category: 'team-setup',
    targetRole: 'coach',
...
/**
 * Supporting Athletes XP tasks for coaches.
 */
const COACH_SUPPORTING_XP_TASKS: Mission[] = [
  {
    id: 'coach-support-1',
...
/**
 * Team Content XP tasks for coaches.
 */
const COACH_CONTENT_XP_TASKS: Mission[] = [
  {
    id: 'coach-content-1',
...
/**
 * Recruiting Support XP tasks for coaches.
 */
const COACH_RECRUITING_XP_TASKS: Mission[] = [
  {
    id: 'coach-recruit-1',
...
/**
 * Professional Development XP tasks for coaches.
 */
const COACH_DEVELOPMENT_XP_TASKS: Mission[] = [
  {
    id: 'coach-dev-1',
...
/**
 * All athlete XP tasks.
 */
export const MOCK_ATHLETE_XP_TASKS: Mission[] = [
  ...ATHLETE_PROFILE_XP_TASKS,
  ...ATHLETE_ENGAGEMENT_XP_TASKS,
  ...ATHLETE_RECRUITING_XP_TASKS,
  ...ATHLETE_SEASONAL_XP_TASKS,
];

/**
 * All coach XP tasks.
 */
export const MOCK_COACH_XP_TASKS: Mission[] = [
  ...COACH_TEAM_SETUP_XP_TASKS,
  ...COACH_SUPPORTING_XP_TASKS,
  ...COACH_CONTENT_XP_TASKS,
  ...COACH_RECRUITING_XP_TASKS,
  ...COACH_DEVELOPMENT_XP_TASKS,
];
...
/**
 * Get XP tasks by category.
 */
export function getMockXpTasksByCategory(
  role: MissionUserRole,
  category: MissionCategory
): Mission[] {
  const tasks = getMockXpTasks(role);
  return tasks.filter((m) => m.category === category);
}

/**
 * Get featured XP tasks.
 */
export function getMockFeaturedXpTasks(role: MissionUserRole): Mission[] {
  const tasks = getMockXpTasks(role);
  return tasks.filter((m) => m.featured && m.status !== 'completed');
}
