/**
 * @fileoverview Profile Overview Web Component
...
export class ProfileOverviewWebComponent implements OnDestroy {
  ...
  protected readonly connectedAccountsList = computed(
    (): ReadonlyArray<{
      ...
      return connectedSources
        ...
        .slice(0, 8)
        .map((cs) => {
          const meta = ProfileOverviewWebComponent.PLATFORM_META[cs.platform.toLowerCase()] ?? def;
