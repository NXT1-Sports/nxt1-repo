          ...
          <div class="tab-content">
            ...
            <div class="tab-plays-section">
              ...
              <div class="plays-filters">
                <label>
                  Personnel:
                  <select class="form-input" [value]="playFilters().personnel || ''" (change)="onPlayFilterChange('personnel', $event)">
                ...
                <label>
                  Side:
                  <select class="form-input" [value]="playFilters().side || ''" (change)="onPlayFilterChange('side', $event)">
                    <option value="">All</option>
                ...
                <label>
                  Concept:
                  <select class="form-input" [value]="playFilters().concept || ''" (change)="onPlayFilterChange('concept', $event)">
                    <option value="">All</option>
                      ...
                      @if (deletingPlayIndex() === $index) {
                        ...
                        @if (play.diagramUrl) {
                          <button
                            ...
                            type="button"
                            (click)="openDiagramModal(play.diagramUrl, play.title || play.name || 'Play')"
                            [attr.aria-label]="
        ...
        @if (activePlaybookTab() === 'callsheet') {
          <div class="tab-content">
            <div class="tab-section">
              ...
              <p class="section-meta">
                Select a game situation and Agent X will rank your best plays for that scenario
                by success metrics.
              </p>
...
export class AgentXPlaybooksPanelComponent {
  ...
  private async movePlayToInstallStage(
    ...
    try {
      await firstValueFrom(
        this.http.patch<MutationResponse>(`${this.baseUrl}/playbooks/${playbook.id}/plays/${playIndex}`, {
          installStage,
        })
      );
