...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DragDropModule, NxtIconComponent, AgentXContextDragDirective],
  template: `
        ...
        >
          @for (folder of folders; track folder.id) {
            <section
              ...
              "
              [class.film-playlist-folder--drop-target]="controller().isFolderDropTarget(folder.id)"
