...
> = {
  athlete: [
    { id: 'athlete-highlight-reel', label: 'Create a highlight reel' },
    { id: 'athlete-recruiting-message', label: 'Draft a recruiting message' },
    { id: 'athlete-film-tendencies', label: 'Review my film for tendencies' },
    { id: 'athlete-game-plan', label: 'Build my game plan' },
    { id: 'athlete-scouting-report', label: 'Generate my scouting report' },
    { id: 'athlete-college-fit', label: 'Find matching college programs' },
    { id: 'athlete-training-plan', label: 'Plan my workout schedule' },
    { id: 'athlete-30-day-plan', label: 'Plan my next 30 days' },
  ],
  coach: [
    { id: 'coach-game-plan', label: 'Build a game plan' },
    { id: 'coach-scouting-report', label: 'Create a scouting report' },
    { id: 'coach-film-tendencies', label: 'Review film for tendencies' },
    { id: 'coach-recruiting-message', label: 'Draft a recruiting message' },
    { id: 'coach-roster-gaps', label: 'Summarize roster gaps' },
    { id: 'coach-practice-plan', label: 'Design a practice script' },
    { id: 'coach-highlight-reel', label: 'Create a highlight reel' },
    { id: 'coach-30-day-plan', label: 'Plan the next 30 days' },
  ],
  director: [
    { id: 'director-game-plan', label: 'Build a game plan' },
    { id: 'director-scouting-report', label: 'Create a scouting report' },
    { id: 'director-film-tendencies', label: 'Review film for tendencies' },
    { id: 'director-recruiting-message', label: 'Draft a recruiting message' },
    { id: 'director-roster-gaps', label: 'Summarize roster gaps' },
    { id: 'director-practice-plan', label: 'Design a practice script' },
    { id: 'director-highlight-reel', label: 'Create a highlight reel' },
    { id: 'director-30-day-plan', label: 'Plan the next 30 days' },
  ],
  general: [
    { id: 'general-game-plan', label: 'Build a game plan' },
    { id: 'general-scouting-report', label: 'Create a scouting report' },
    { id: 'general-film-tendencies', label: 'Review film for tendencies' },
    { id: 'general-recruiting-message', label: 'Draft a recruiting message' },
    { id: 'general-roster-gaps', label: 'Summarize roster gaps' },
    { id: 'general-practice-plan', label: 'Design a practice script' },
    { id: 'general-highlight-reel', label: 'Create a highlight reel' },
    { id: 'general-30-day-plan', label: 'Plan the next 30 days' },
  ],
};
  ...
  styles: [
    `
      ...
      @media (max-width: 768px) {
        .chat-scroll-to-bottom {
          bottom: calc(
            108px + env(safe-area-inset-bottom, 0px) + var(--agent-keyboard-offset, 0px)
          );
        }

        :host.agent-x-operation-chat--embedded .chat-scroll-to-bottom {
          bottom: calc(
            100px + env(safe-area-inset-bottom, 0px) + var(--agent-keyboard-offset, 0px)
          );
        }
      }
...
export class AgentXOperationChatComponent implements AfterViewInit, OnDestroy {
  ...
  private isExpiredApprovalYield(msg: OperationMessage): boolean {
    return this.isExpiredApprovalYieldState(this.approvalYieldForMessage(msg));
  }

  private isExpiredApprovalYieldState(yieldState: AgentYieldState | null | undefined): boolean {
    if (yieldState?.reason !== 'needs_approval' || !yieldState.expiresAt) {
      return false;
    }

    const expiresAtMs = new Date(yieldState.expiresAt).getTime();
  ...
  private pendingComposerReplyTarget(): {
    ...
    if (this.isExpiredApprovalYieldState(yieldState)) return null;
