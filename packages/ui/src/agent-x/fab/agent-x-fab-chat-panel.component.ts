              ...
              >
                ...
                @if (message.attachments?.length) {
                  <div class="msg-attachments">
                    @for (att of message.attachments; track att.url + $index) {
                      <div
                        class="msg-attachment"
                        [class.msg-attachment--media]="att.type === 'image' || att.type === 'video'"
                      >
                        @if (att.type === 'image') {
                          <img [src]="att.url" [alt]="att.name" class="msg-attachment__thumb" />
                          ...
                          <div class="msg-attachment__doc" style="cursor: pointer;">
                            <div class="msg-attachment__doc-icon-wrap">
                              <svg
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke="currentColor"
