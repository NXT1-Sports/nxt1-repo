...
@Component({
  ...
  standalone: true,
  imports: [NxtIconComponent, NxtMarkdownComponent, NxtStateViewComponent],
...
export class AthleteIntelComponent {
  ...
  /** Active Intel section id from the profile shell side-nav. */
  readonly activeSection = input<string>('agent_x_brief');
