...
4. The platform generates a unique team code automatically
...
**Via team code** — If the athlete has the team code (4-10 alphanumeric characters), they can go to Add Sport / Team and enter it manually to request to join.
