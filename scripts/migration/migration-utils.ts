 ...
 * For production: checks PRODUCTION_FIREBASE_* then falls back to FIREBASE_* env vars.
 * For staging: checks STAGING_FIREBASE_* env vars.
 * Falls back to SA file if env vars not found.
 */
